...
class login:
     def __init__(self,window):
        ...
        self.frame = Frame(self.window,bg='light pink',width=700,height=400)  #creating frame

     def loginfn(self):

        self.label = Label(self.frame,text='Log In',bg='light blue',font=('Georgia',36,'bold'))

        self.name = Label(self.frame,text='Enter User_Name: ',bg='light blue',font=('Arial',18,'bold'))

        self.namee_text=StringVar()
        self.namee = Entry(self.frame,textvariable=self.namee_text,fg='gray',width=25,font=('Arial',16,'bold'))

        self.password1 = Label(self.frame,text='Enter Password : ',bg='light blue', fg='Green',font=('Arial',18,'bold'))
        ...
        if self.flag !=0:
            self.buttonAdmin = Button(self.frame,text='Admin',bg='light blue',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.adminbutton2)
        else:
            self.buttonAdmin = Button(self.frame,text='Admin',bg='light blue',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.adminbutton)

        self.buttonStudent = Button(self.frame,text='Student',bg='light blue',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.studentbutton)
	# placing
     ...
     def register(self):
         ...
         self.labelr = Label(self.frame,text='Register',bg='light blue',font=('Georgia',32,'bold'))

         self.namer = Label(self.frame,text='Name : ',bg='light blue',font=('Arial',14,'bold'))

         self.namere_text=StringVar()
         self.namere = Entry(self.frame,textvariable=self.namere_text,fg='gray')

         self.idr = Label(self.frame,text='Roll No. : ',bg='light blue',font=('Arial',14,'bold'))

         self.rollno_text=StringVar()
         self.idre = Entry(self.frame,textvariable=self.rollno_text,fg='gray',width=25,font=('Arial',12,'bold'))

         self.passwordr1 = Label(self.frame,text='Create Password : ',bg='light blue', fg='Green',font=('Arial',14,'bold'))
         ...
         self.passwordr2 = Label(self.frame,text='Reenter Password : ',bg='light blue', fg='Green',font=('Arial',14,'bold'))
     ...
     def studentbutton(self):
        ...
        self.name = Label(self.frame,text='Enter Name: ',bg='light blue',font=('Arial',18,'bold'))
        self.name.place(x=100,y=140,width=240,height=60)
